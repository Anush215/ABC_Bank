...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2020 at 08:18 AM
...
--
ALTER TABLE `customer_acc`
  MODIFY `account_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100006;
COMMIT;
